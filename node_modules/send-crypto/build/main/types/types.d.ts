...
export interface DeferHandler<Options = {}> {
    readonly address: (asset: Asset, options?: any & {}) => Promise<string> | string;
...
export declare abstract class Handler<ConstructorOptions = {}, AddressOptions = {}, BalanceOptions extends {
    ...
    address?: (asset: Asset, options: AddressOptions, deferHandler: DeferHandler) => Promise<string> | string;
