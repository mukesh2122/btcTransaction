...
var Filecoin = function Filecoin(provider) {
  ...
  (0, _defineProperty2["default"])(this, "sendMessage", /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(message, signature) {
      var signedMessage;
          ...
          switch (_context5.prev = _context5.next) {
            ...
            case 6:
              ...
              if (_context5.t0.message.toLowerCase().includes('actor not found')) {
                ...
                if (!clonedMsg.From) clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[networkPrefix];
                if (clonedMsg.From[1] === '0') clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[networkPrefix];else if (clonedMsg.From[1] === '1') clonedMsg.From = _utils.KNOWN_TYPE_1_ADDRESS[networkPrefix];else if (clonedMsg.From[1] === '3') clonedMsg.From = _utils.KNOWN_TYPE_3_ADDRESS[networkPrefix];else {
                  // this should never happen, only t1 and t3 addresses can be used as a from?
                  clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[networkPrefix];
                }
              }
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              newPremium = new _bignumber.BigNumber(message.GasPremium).multipliedBy(125).dividedBy(100);

              if (newPremium.isGreaterThan(message.GasFeeCap)) {
                newFeeCap = newPremium.toFixed(0, _bignumber.BigNumber.ROUND_CEIL);
              }

              return _context13.abrupt("return", {
                gasFeeCap: newFeeCap,
                gasPremium: newPremium.toFixed(0, _bignumber.BigNumber.ROUND_CEIL),
