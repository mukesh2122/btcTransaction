...
export declare type LocalNodeProviderOptions = {
    apiAddress: string;
    token?: string;
};
export declare class LocalNodeProvider implements WalletSubProvider {
...
//# sourceMappingURL=local-node-provider.d.ts.map